                  ...
                  <tr v-for="(admin, index) in admins" :key="admin.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <Modal @close="toggleModal" :modalActive="modalActive">
                        ...
                        <div class="flex justify-center pt-2">
                            ...
                            <button @click="deleteItem(admin.id)" class="modal-close px-4 bg-red-600 p-3 rounded-lg text-white hover:bg-red-400">Hapus</button>
                          </div>
                      </Modal>
                  </tr>  
              </tbody>
...
export default {
  ...
  methods: {
    ...
    editItem(id) {
      ...
      this.$router.push({ name: 'Edit Admin Data', params: { id: id } });
    },
    nextPage() {
